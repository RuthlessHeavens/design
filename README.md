...
Set in a brutal fantasy world where the very fabric of existence is defined by its denizens relentless pursuit for supremacy. Here, all know woe and even the heavens are ruthless.
...
- **Brawl**: play by your own rules. use built-in tools to create custom cards and adjust various gameplay parameters. *(no balance considerations)*
